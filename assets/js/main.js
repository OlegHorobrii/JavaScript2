 ...
 * #2
 *
 * Для объекта из п.1 создайте метод fullName, который будет возвращать
 * полное имя,
...
function mainFunc(a, b, func) {
  ...
  if (func && typeof func === 'function') return func(a, b); return false;
}
...
console.log(mainFunc(5, 6, cbAdd));
/*
